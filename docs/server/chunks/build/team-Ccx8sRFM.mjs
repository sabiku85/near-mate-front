import { a as _sfc_main$9, d as __nuxt_component_1, c as _sfc_main$c, e as useAppConfig, h as usePortal, f as useFormField, i as useFieldGroup, j as useComponentIcons, t as tv, k as isArrayOfArray, b as _sfc_main$e, l as get, m as _sfc_main$d, o as getDisplayValue } from './server.mjs';
import { _ as _sfc_main$2 } from './Card-CHiw-Xxq.mjs';
import { _ as _sfc_main$3 } from './Badge-Dc66ggRY.mjs';
import { _ as _sfc_main$4 } from './Modal-Br2hsqbk.mjs';
import { _ as _sfc_main$5 } from './Form-aHvdyz-h.mjs';
import { _ as _sfc_main$6 } from './Input-Dz3KWK_v.mjs';
import { defineComponent, ref, reactive, resolveComponent, withCtx, createVNode, createTextVNode, unref, toDisplayString, createBlock, openBlock, Fragment, renderList, isRef, useSlots, toRef, computed, useTemplateRef, mergeProps, createCommentVNode, renderSlot, useSSRContext } from 'vue';
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("../node_modules/.pnpm/@nuxt+ui@4.2.1_@babel+parser@7.28.6_change-case@5.4.4_db0@0.3.4_embla-carousel@8.6.0_io_781fbb2832b450b29d62363b67397d64/node_modules/@nuxt/ui/dist/runtime/components/Select.vue");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(_attrs)}><div class="mb-6 flex justify-between items-center"><div><h1 class="text-3xl font-bold text-gray-900 dark:text-white"> Team </h1><p class="text-gray-600 dark:text-gray-400 mt-2"> Manage your team members </p></div>`);
      ...
      _push(ssrRenderComponent(_component_UCard, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="overflow-x-auto"${_scopeId}><table class="w-full"${_scopeId}><thead${_scopeId}><tr class="border-b border-gray-200 dark:border-gray-700"${_scopeId}><th class="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white"${_scopeId}> Member </th><th class="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white"${_scopeId}> Role </th><th class="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white"${_scopeId}> Status </th><th class="text-left py-3 px-4 font-semibold text-gray-900 dark:text-white"${_scopeId}> Actions </th></tr></thead><tbody${_scopeId}><!--[-->`);
            ssrRenderList(unref(teamMembers), (member) => {
              _push2(`<tr class="border-b border-gray-100 dark:border-gray-800 hover:bg-gray-50 dark:hover:bg-gray-800"${_scopeId}><td class="py-4 px-4"${_scopeId}><div class="flex items-center space-x-3"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UAvatar, {
                src: member.avatar,
                alt: member.name,
                size: "sm"
              }, null, _parent2, _scopeId));
              _push2(`<div${_scopeId}><p class="font-medium text-gray-900 dark:text-white"${_scopeId}>${ssrInterpolate(member.name)}</p><p class="text-sm text-gray-500 dark:text-gray-400"${_scopeId}>${ssrInterpolate(member.email)}</p></div></div></td><td class="py-4 px-4"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UBadge, {
                color: member.role === "Admin" ? "purple" : "gray"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(member.role)}`);
                  } else {
                    return [
              ...
              _push2(`</td><td class="py-4 px-4"${_scopeId}>`);
              _push2(ssrRenderComponent(_component_UBadge, {
                color: member.status === "Active" ? "green" : "yellow"
              }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`${ssrInterpolate(member.status)}`);
                  } else {
                    return [
              ...
              _push2(`</td><td class="py-4 px-4"${_scopeId}><div class="flex space-x-2"${_scopeId}>`);
                ...
                createVNode("table", { class: "w-full" }, [
                  createVNode("thead", null, [
                    createVNode("tr", { class: "border-b border-gray-200 dark:border-gray-700" }, [
                      createVNode("th", { class: "text-left py-3 px-4 font-semibold text-gray-900 dark:text-white" }, " Member "),
                      createVNode("th", { class: "text-left py-3 px-4 font-semibold text-gray-900 dark:text-white" }, " Role "),
                      createVNode("th", { class: "text-left py-3 px-4 font-semibold text-gray-900 dark:text-white" }, " Status "),
                      createVNode("th", { class: "text-left py-3 px-4 font-semibold text-gray-900 dark:text-white" }, " Actions ")
                    ])
                  ]),
                  createVNode("tbody", null, [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(teamMembers), (member) => {
                        ...
                        createVNode("td", { class: "py-4 px-4" }, [
                          createVNode("div", { class: "flex items-center space-x-3" }, [
                            ...
                            createVNode("div", null, [
                              createVNode("p", { class: "font-medium text-gray-900 dark:text-white" }, toDisplayString(member.name), 1),
                              createVNode("p", { class: "text-sm text-gray-500 dark:text-gray-400" }, toDisplayString(member.email), 1)
                            ])
                          ])
                        ]),
                        createVNode("td", { class: "py-4 px-4" }, [
      ...
      _push(ssrRenderComponent(_component_UModal, {
        modelValue: unref(showInviteModal),
        "onUpdate:modelValue": ($event) => isRef(showInviteModal) ? showInviteModal.value = $event : null
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, null, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<h3 class="text-lg font-semibold"${_scopeId2}>Invite Team Member</h3>`);
                } else {
                  return [
                    createVNode("h3", { class: "text-lg font-semibold" }, "Invite Team Member")
                  ];
                }
              }),
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                          ...
                          default: withCtx((_4, _push5, _parent5, _scopeId4) => {
                            if (_push5) {
                              _push5(ssrRenderComponent(_component_USelect, {
                                modelValue: unref(inviteForm).role,
...
//# sourceMappingURL=team-Ccx8sRFM.mjs.map
